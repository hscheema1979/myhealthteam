...
def test_complete_workflow():
    ...
    # Verify consistency
    if (onboarding_record and patient_record and assignment_record and
        onboarding_record['patient_id'] == patient_record['patient_id'] == assignment_record['patient_id']):
        print("✓ SUCCESS: Complete workflow works correctly!")
        print(f"✓ All tables use the same patient_id: {result_patient_id}")
    else:
        print("✗ FAILURE: Inconsistent patient_id across tables")
