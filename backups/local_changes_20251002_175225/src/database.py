...
# =============================================================================
# DATABASE PATH CONFIGURATION - ENVIRONMENT SEPARATION
# =============================================================================
# This configuration ensures proper environment separation:
# - Production (port 8501): D:\Git\myhealthteam2\Streamlit\production.db
# - Sandbox (port 8502): D:\Git\myhealthteam2\Dev\sandbox.db  
# - Development (port 8503): D:\Git\myhealthteam2\Dev\development.db
# =============================================================================

def get_database_path():
    """
    Determine the correct database path based on environment variables.
    Priority order:
    1. DATABASE_PATH environment variable (explicit override)
    2. STREAMLIT_SERVER_PORT environment variable (auto-detection)
    3. Default to production.db (fallback)
    """
    ...
    # Auto-detect based on Streamlit port
    port = os.environ.get('STREAMLIT_SERVER_PORT', '8501')
    
    if port == '8501':
        # Production environment
        return r'D:\Git\myhealthteam2\Streamlit\production.db'
    elif port == '8502':
        # Sandbox environment
        return r'D:\Git\myhealthteam2\Dev\sandbox.db'
    elif port == '8503':
        # Development environment
        return r'D:\Git\myhealthteam2\Dev\development.db'
    else:
        # Unknown port - default to production for safety
        return r'D:\Git\myhealthteam2\Streamlit\production.db'

# Set the database path using the environment-aware function
...
logger.info(f"STREAMLIT_SERVER_PORT: {os.environ.get('STREAMLIT_SERVER_PORT', 'Not set')}")
logger.info(f"DATABASE_PATH override: {os.environ.get('DATABASE_PATH', 'Not set')}")
...
def get_db_connection(db_path: str = None):
    ...
    Otherwise, uses the environment-appropriate database path.
    """
    if db_path is None:
        db_path = DB_PATH
