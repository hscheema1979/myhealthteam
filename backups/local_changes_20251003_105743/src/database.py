...
def get_onboarding_queue():
    ...
    try:
        ...
        ORDER BY 
            CASE 
                WHEN op.stage4_complete = 1 THEN 1  -- Almost done (highest priority)
                WHEN op.stage3_complete = 1 THEN 2
                WHEN op.stage2_complete = 1 THEN 3
                WHEN op.stage1_complete = 1 THEN 4
                ELSE 5  -- Just started (lowest priority)
            END,
