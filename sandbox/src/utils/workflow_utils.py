...
def create_workflow_task(coordinator_id, patient_name, workflow_type, priority, notes, estimated_duration):
    ...
    try:
        ...
        # Create workflow instance using new database function
        instance_id = database.create_workflow_instance(
            template_id=template['template_id'],
            patient_id=patient_id,
            coordinator_id=coordinator_id,
            notes=f"Priority: {priority} | {notes} | Est. Duration: {estimated_duration}min"
        )
