-- Repeatable: Transform provider and coordinator data for 1999_12
-- Usage: Replace {YYYY_MM} with the desired year and month (e.g., 1999_12)
-- Provider transformation uses SOURCE_PSL_TASKS_1999_12 as source
CREATE TABLE IF NOT EXISTS provider_tasks_1999_12 (
...
DELETE FROM provider_tasks_1999_12;
INSERT INTO provider_tasks_1999_12 (
        provider_task_id,
        task_id,
        provider_id,
        provider_name,
...
SELECT t."1" AS provider_task_id,
    ...
    'monthly_PSL',
    CURRENT_TIMESTAMP
FROM SOURCE_PSL_TASKS_1999_12 t
...
-- Coordinator transformation uses SOURCE_CM_TASKS_1999_12 as source
CREATE TABLE IF NOT EXISTS coordinator_tasks_1999_12 (
    coordinator_id TEXT,
    patient_id TEXT,
    task_date TEXT,
...
DELETE FROM coordinator_tasks_1999_12;
INSERT INTO coordinator_tasks_1999_12 (
        coordinator_id,
        patient_id,
        task_date,
        duration_minutes,
...
SELECT scm.user_id AS coordinator_id,
    ...
    'monthly_CM',
    CURRENT_TIMESTAMP
FROM SOURCE_CM_TASKS_1999_12 t
