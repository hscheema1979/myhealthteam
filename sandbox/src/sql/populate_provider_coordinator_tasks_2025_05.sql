...
-- Usage: Replace 2025_05 with the desired year and month (e.g., 2025_09)
-- Provider transformation uses SOURCE_PSL_TASKS_2025_05 as source
-- Provider transformation uses SOURCE_PSL_TASKS_2025_05 as source
DROP TABLE IF EXISTS provider_tasks_2025_05;
CREATE TABLE IF NOT EXISTS provider_tasks_2025_05 (
...
DELETE FROM provider_tasks_2025_05;
INSERT INTO provider_tasks_2025_05 (
        provider_task_id,
        task_id,
        provider_id,
        provider_name,
...
SELECT t."1" AS provider_task_id,
    ...
    'monthly_PSL',
    CURRENT_TIMESTAMP
FROM SOURCE_PSL_TASKS_2025_05 t
...
-- Coordinator transformation uses SOURCE_CM_TASKS_2025_05 as source
-- Coordinator transformation uses SOURCE_CM_TASKS_2025_05 as source
DROP TABLE IF EXISTS coordinator_tasks_2025_05;
CREATE TABLE IF NOT EXISTS coordinator_tasks_2025_05 (
    coordinator_id TEXT,
    patient_id TEXT,
    task_date TEXT,
...
DELETE FROM coordinator_tasks_2025_05;
...
SELECT scm.user_id AS coordinator_id,
    ...
    'monthly_CM',
    CURRENT_TIMESTAMP
FROM SOURCE_CM_TASKS_2025_05 t
