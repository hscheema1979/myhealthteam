...
-- Usage: Replace 2025_08 with the desired year and month (e.g., 2025_09)
-- Provider transformation uses SOURCE_PSL_TASKS_2025_08 as source
-- Provider transformation uses SOURCE_PSL_TASKS_2025_08 as source
DROP TABLE IF EXISTS provider_tasks_2025_08;
CREATE TABLE IF NOT EXISTS provider_tasks_2025_08 (
...
DELETE FROM provider_tasks_2025_08;
INSERT INTO provider_tasks_2025_08 (
        provider_task_id,
        task_id,
        provider_id,
        provider_name,
...
SELECT t."1" AS provider_task_id,
    ...
    'monthly_PSL',
    CURRENT_TIMESTAMP
FROM SOURCE_PSL_TASKS_2025_08 t
...
-- Coordinator transformation uses SOURCE_CM_TASKS_2025_08 as source
-- Coordinator transformation uses SOURCE_CM_TASKS_2025_08 as source
DROP TABLE IF EXISTS coordinator_tasks_2025_08;
CREATE TABLE IF NOT EXISTS coordinator_tasks_2025_08 (
    coordinator_id TEXT,
    patient_id TEXT,
    task_date TEXT,
...
DELETE FROM coordinator_tasks_2025_08;
INSERT INTO coordinator_tasks_2025_08 (
        coordinator_id,
        patient_id,
        task_date,
        duration_minutes,
...
SELECT scm.user_id AS coordinator_id,
    ...
    'monthly_CM',
    CURRENT_TIMESTAMP
FROM SOURCE_CM_TASKS_2025_08 t
