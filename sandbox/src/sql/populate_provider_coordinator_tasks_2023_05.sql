-- Repeatable: Transform provider and coordinator data for 2023_05
-- Usage: Replace {YYYY_MM} with the desired year and month (e.g., 2023_05)
-- Provider transformation uses SOURCE_PSL_TASKS_2023_05 as source
CREATE TABLE IF NOT EXISTS provider_tasks_2023_05 (
...
DELETE FROM provider_tasks_2023_05;
INSERT INTO provider_tasks_2023_05 (
        provider_task_id,
        task_id,
        provider_id,
        provider_name,
...
SELECT t."1" AS provider_task_id,
    ...
    'monthly_PSL',
    CURRENT_TIMESTAMP
FROM SOURCE_PSL_TASKS_2023_05 t
