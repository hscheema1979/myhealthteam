-- Create patient_visits table from provider_tasks only
CREATE TABLE IF NOT EXISTS patient_visits (
    patient_id TEXT PRIMARY KEY,
    last_visit_date TEXT,
    service_type TEXT
);
-- Populate patient_visits with latest visit date and service_type per patient from provider_tasks only
INSERT
