...
-- TRIM(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(t.[Patient Last, First DOB]),'ZEN-',''),'PM-',''),'ZMN-',''),'BLESSEDCARE-',''),'BLEESSEDCARE-',''),'3PR-',''),'BLESSEDCARE ',''),'BLEESSEDCARE ',''),'3PR ',''),', ',' '),',',' ')) AS patient_id

-- For SOURCE_CM_TASKS tables:
-- TRIM(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(t.[Pt Name]),'ZEN-',''),'PM-',''),'ZMN-',''),'BLESSEDCARE-',''),'BLEESSEDCARE-',''),'3PR-',''),'BLESSEDCARE ',''),'BLEESSEDCARE ',''),'3PR ',''),', ',' '),',',' ')) AS patient_id
...
-- Input: '3PR BROWN  DAVID  05/15/1990' -> Output: 'BROWN DAVID 05/15/1990'