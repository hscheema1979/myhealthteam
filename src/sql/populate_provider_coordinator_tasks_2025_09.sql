...
-- Provider transformation uses SOURCE_PSL_TASKS_2025_09 as source
DROP TABLE IF EXISTS provider_tasks_2025_09;
CREATE TABLE IF NOT EXISTS provider_tasks_2025_09 (
...
DELETE FROM provider_tasks_2025_09;
...
SELECT t."1" AS provider_task_id,
    ...
    'monthly_PSL',
    CURRENT_TIMESTAMP
FROM SOURCE_PSL_TASKS_2025_09 t
...
-- Coordinator transformation uses SOURCE_CM_TASKS_2025_09 as source
DROP TABLE IF EXISTS coordinator_tasks_2025_09;
CREATE TABLE IF NOT EXISTS coordinator_tasks_2025_09 (
    coordinator_id TEXT,
    patient_id TEXT,
    task_date TEXT,
...
DELETE FROM coordinator_tasks_2025_09;
...
SELECT scm.user_id AS coordinator_id,
    ...
    'monthly_CM',
    CURRENT_TIMESTAMP
FROM SOURCE_CM_TASKS_2025_09 t
