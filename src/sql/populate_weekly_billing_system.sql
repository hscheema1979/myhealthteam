...
-- First, ensure the provider_task_billing_status table exists (it should from create script)
-- Then populate it with existing provider task data
-- Insert billing records for all existing provider tasks
