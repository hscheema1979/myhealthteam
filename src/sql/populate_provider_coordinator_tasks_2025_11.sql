...
-- Usage: Replace {YYYY_MM} with the desired year and month (e.g., 2025_11)
-- Provider transformation uses SOURCE_PSL_TASKS_2025_11 as source
ATTACH '.\sheets_data.db' AS staging;
DROP TABLE IF EXISTS provider_tasks_2025_11;
CREATE TABLE IF NOT EXISTS provider_tasks_2025_11 (
...
DELETE FROM provider_tasks_2025_11;
INSERT INTO provider_tasks_2025_11 (
        provider_task_id,
        task_id,
        provider_id,
        provider_name,
...
SELECT t."1" AS provider_task_id,
    ...
    'monthly_PSL',
    CURRENT_TIMESTAMP
FROM staging.SOURCE_PSL_TASKS_2025_11 t
...
-- Coordinator transformation uses SOURCE_CM_TASKS_2025_11 as source
DROP TABLE IF EXISTS coordinator_tasks_2025_11;
CREATE TABLE IF NOT EXISTS coordinator_tasks_2025_11 (
    coordinator_id TEXT,
    patient_id TEXT,
    task_date TEXT,
...
DELETE FROM coordinator_tasks_2025_11;
INSERT INTO coordinator_tasks_2025_11 (
        coordinator_id,
        patient_id,
        task_date,
        duration_minutes,
...
SELECT scm.user_id AS coordinator_id,
    ...
    'monthly_CM',
    CURRENT_TIMESTAMP
FROM staging.SOURCE_CM_TASKS_2025_11 t
