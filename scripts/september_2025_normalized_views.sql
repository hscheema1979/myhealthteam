...
SELECT
  ...
  service AS service,
  minutes_raw AS minutes_of_service
...
CREATE TEMP TABLE IF NOT EXISTS SEPT_2025_PROVIDER_SUMMARY AS
SELECT 
...
CREATE TEMP TABLE IF NOT EXISTS SEPT_2025_COORDINATOR_SUMMARY AS
SELECT 
